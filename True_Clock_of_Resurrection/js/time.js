...
function handleTickInit(tick) {
	...
	// compose counter WITH WILL AND THE NAME OF THE CLOCK!
	Tick.count.down('2280-01-17T15:49:32+00:00', { format: ['y','M','d','h','m','s'] }).onupdate = function (value) {
		tick.value = value;
	};
}
...
const syncData75 = [
	...
	{start: '10.000', text: '<p class="verses"><a target="_blank" class="antique-link" href="http://honourablequran.blogspot.com/p/75.html?m=1#0">75:0</a>&nbsp;IN THE NAME OF ALLAH RAHMAN RAHIM!</p>'},
...
const syncData89 = [
	...
	{start: '13.583', text: '<p class="verses"><a target="_blank" class="antique-link" href="http://honourablequran.blogspot.com/p/89.html?m=1#0">89:0</a>&nbsp;IN THE NAME OF ALLAH RAHMAN RAHIM!</p>'},
...
const syncData100 = [
	...
	{start: '6.979', text: '<p class="verses"><a target="_blank" class="antique-link" href="http://honourablequran.blogspot.com/p/100.html?m=1#0">100:0</a>&nbsp;IN THE NAME OF ALLAH RAHMAN RAHIM!</p>'},
	...
	{start: '32.445', text: '<p class="verses"><a target="_blank" class="antique-link" href="http://honourablequran.blogspot.com/p/100.html?m=1#9">100:9</a>&nbsp;Does he not realize that THE DAY will come (17/01/2280 UTC 15:49:32) when the graves are OPENED?</p>'},
